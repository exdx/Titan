...
class PocStrategy(StrategySimulator):
    ...
    def __init__(self, interval, exchange, base_currency, quote_currency, is_simulated, sim_balance=0):
        ...
        self.buy_signal = sma_crossover_signal.SmaCrossoverSignal(self.market, 100, 700, self.interval)
